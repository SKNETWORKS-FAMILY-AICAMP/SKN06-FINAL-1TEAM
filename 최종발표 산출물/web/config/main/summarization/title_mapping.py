def find_best_matching_titles(query: str,llm, available_titles: list, top_k: int = 5) -> list:
    """
    ...
    3. 질문이 일반적인 재무(예: "최근 3년간 매출, 영업이익, 당기순이익, 자본금")와 연관된 데이터를 요청하는 경우:
       - "요약재무정보" 및 "재무제표"가 포함된 title을 우선 선택하세요.

    4. "시장 점유율", "주요 산업", "경쟁사 분석", "차별화 요소"와 관련된 질문이 포함된 경우:
       - "사업의 개요", "주요 제품 및 서비스" 등의 title을 우선 선택하세요.
   ...
   7. 질문에 "신용"이 포함되어있으면 반드시 회사의 개요를 포함하세요

    **주의:** 반드시 가장 적절한 title 5개 이하만 선택하세요.  
