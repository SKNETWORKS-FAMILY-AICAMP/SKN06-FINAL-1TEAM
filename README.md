...
- **백하은**: 
- **김지영**: 
- **노원재**: 데이터의 흐름을 설계하고 모델을 다듬는 과정은 거친 돌을 정교하게 깎아 하나의 조각을 완성하는 과정과 같았습니다.
                      끊임없는 시행착오를 통해 복잡한 알고리즘 속에서 길을 잃을 때도 있었지만, 팀원들과의 협업을 통해 퍼즐 조각들을 맞춰가며 결국 하나의 완성된 그림을 만들어냈습니다.
- **박창규**: 
